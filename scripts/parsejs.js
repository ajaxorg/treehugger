define(["ast", "narcissus/jsdefs", "narcissus/jslex", "narcissus/jsparse"], function(ast) {
    function parse(s) {
      try {
    ...
    function transform(n) {
      ...
      case "var":
        return new ast.ConsNode("VarDecls", [new ast.ListNode(n.children.map(function(vardec) {
            return new ast.ConsNode("VarDecl", [new ast.StringNode(vardec.name), transform(vardec.initializer)]);
          }))], meta);
      case "return":
      ...
      case ".":
        return new ast.ConsNode("FieldAccess", [transform(n.children[0]), transform(n.children[1])], meta);
      case "IDENTIFIER":
      ...
      case "*":
        return new ast.ConsNode("Op", [new ast.StringNode("*"), transform(n.children[0]), transform(n.children[1])], meta);
      default:
        console.log(n, Narcissus.definitions.tokens[n.type]);
      }
    }
    return {
      parse: parse
