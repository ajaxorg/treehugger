...
exports.fail = function(node) {
  return new FailNode(node);
};
...
// fn return boolean
ListNode.prototype.filter = function(fn) {
  var matching = [];
...
NumNode.prototype.match = function(t, matches) {
  ...
  if (t instanceof NumNode) {
    return this.n === t.n ? matches : false;
  } else {
    return false;
  }
};
...
exports.num = function(n, meta) {
  return new NumNode(n, meta);
};
...
StringNode.prototype.match = function(t, matches) {
  ...
  if (t instanceof StringNode) {
    return this.s === t.s ? matches : false;
  } else {
    return false;
  }
};
...
exports.string = function(s, meta) {
  return new StringNode(s, meta);
};
