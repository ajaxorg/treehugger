...
define(function () {
    ...
    ast.cons = function(name, children, meta) {
    ...
    ast.list = function(elements, meta) {
    ...
    ast.int = function(n, meta) {
      return new IntNode(n, meta);
    };
    ...
    ast.placeholder = function(n, meta) {
