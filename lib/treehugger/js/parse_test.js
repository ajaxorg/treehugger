...
module.exports = {
    "test basic parsing" : function() {
        ...
        node = parser.parse("with(a) { console.log(b); }");
        console.log(""+parser.parse("let letVar, letB = true;"));
    },
    ...
    "test error recovery" : function() {
        ...
        assert.equal(parser.parse("(function() { hello.})();").toString(), '[Function("",[],[PropAccess(Var("hello"),""),ERROR(),ERROR()])]');
