require({baseUrl: "lib"}, ["treehugger/tree", "treehugger/traverse", "treehugger/js/parse", "treehugger/js/infer", "treehugger/coffeescript/parser", "jquery"], function(tree, traverse, parsejs, infer, parsecs) {
